  ...
  output_frame_(declare_parameter<std::string>("base_link", "base_link"))
{
  ...
  linear_acceleration_offset_x_imu_link_ = declare_parameter<double>("linear_acceleration_offset_x", 0.0);
  linear_acceleration_offset_y_imu_link_ = declare_parameter<double>("linear_acceleration_offset_y", 0.0);
  linear_acceleration_offset_z_imu_link_ = declare_parameter<double>("linear_acceleration_offset_z", 0.0);
...
void ImuCorrector::callbackImu(const sensor_msgs::msg::Imu::ConstSharedPtr imu_msg_ptr)
{
  ...
  imu_msg.angular_velocity.x -= linear_acceleration_offset_x_imu_link_;
  imu_msg.angular_velocity.y -= linear_acceleration_offset_y_imu_link_;
  imu_msg.angular_velocity.z -= linear_acceleration_offset_z_imu_link_;

  imu_msg.linear_acceleration.x -= angular_velocity_offset_x_imu_link_;
  imu_msg.linear_acceleration.y -= angular_velocity_offset_y_imu_link_;
  imu_msg.linear_acceleration.z -= angular_velocity_offset_z_imu_link_;
