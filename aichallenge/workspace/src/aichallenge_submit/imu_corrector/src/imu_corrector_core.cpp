...
void ImuCorrector::callbackImu(const sensor_msgs::msg::Imu::ConstSharedPtr imu_msg_ptr)
{
  ...
  imu_msg.linear_acceleration.x -= linear_acceleration_offset_x_imu_link_;
  imu_msg.linear_acceleration.y -= linear_acceleration_offset_y_imu_link_;
  imu_msg.linear_acceleration.z -= linear_acceleration_offset_z_imu_link_;
